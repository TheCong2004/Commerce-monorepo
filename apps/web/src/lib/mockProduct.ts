...
images: [
  ...
  // ==================== PDF BOOK PRODUCTS ====================
  {
    ...
    images: [{ url: "https://images.unsplash.com/photo-1532012197267-da84d127e765?auto=format&fit=crop&q=80&w=900" }],
    rating: 4.8,
    views: 18200,
    downloads: 920,
    metadata: {
      ...
      table_of_contents: [
        { title: "Tổng quan phễu bán hàng số", page: 8 },
        { title: "Xây dựng nội dung chuyển đổi", page: 32 },
        { title: "Quảng cáo cơ bản cho shop nhỏ", page: 74 },
        { title: "Đo lường chỉ số và tối ưu", page: 126 },
      ],
    },
    variants: [
      {
        id: "pdf-book-1-v1",
        title: "PDF Download",
        calculated_price: { calculated_amount: 149000, original_amount: 249000 },
        options: [{ value: "PDF" }],
      },
    ],
    options: [],
  ...
  },
  {
    ...
    images: [{ url: "https://images.unsplash.com/photo-1516321318423-f06f85e504b3?auto=format&fit=crop&q=80&w=900" }],
    rating: 4.7,
    views: 12100,
    downloads: 540,
    metadata: {
      ...
      table_of_contents: [
        { title: "Thiết lập quy trình cốt lõi", page: 6 },
        { title: "Mẫu checklist vận hành", page: 28 },
        { title: "Quản lý tiền và tồn kho", page: 64 },
        { title: "Dashboard theo dõi hiệu suất", page: 104 },
      ],
    },
    variants: [
      {
        id: "pdf-book-2-v1",
        title: "PDF Download",
        calculated_price: { calculated_amount: 129000, original_amount: 199000 },
        options: [{ value: "PDF" }],
      },
    ],
    options: [],
    ...
    variants: [
      {
        ...
        calculated_price: { calculated_amount: 49000, original_amount: 99000 },
    ...
    variants: [
      {
        ...
        title: "Template Pack",
        calculated_price: { calculated_amount: 39000, original_amount: 79000 },
        options: [{ value: "Digital" }],
      },
    ],
    options: [],
  ...
  // ==================== AGRICULTURE PRODUCTS ====================
  {
    ...
    metadata: {
      ...
      compatibility: ["Vegetable farms", "Fruit orchards", "Greenhouse crops", "Soil recovery"],
    },
    variants: [
      {
        id: "agriculture-1-v1",
        title: "25 kg bag",
        calculated_price: { calculated_amount: 180000, original_amount: 240000 },
        options: [{ value: "25 kg" }],
      },
    ],
    options: [],
  ...
  },
  {
    ...
    metadata: {
      ...
      compatibility: ["Home gardens", "Organic farms", "Greenhouse crops", "Retail seed kits"],
    },
    variants: [
      {
        id: "agriculture-2-v1",
        title: "50 g seed pack",
        calculated_price: { calculated_amount: 59000, original_amount: 89000 },
        options: [{ value: "50 g" }],
      },
    ],
    options: [],
    ...
    variants: [
      {
        ...
        title: "SIM + MAX120",
        calculated_price: { calculated_amount: 85000000, original_amount: 92000000 },
        options: [{ value: "eSIM" }],
      },
    ],
    options: [],
    ...
    variants: [
      {
        ...
        title: "SIM + DATA90",
        calculated_price: { calculated_amount: 120000000, original_amount: 138000000 },
        options: [{ value: "Physical SIM" }],
      },
    ],
    options: [],
    weight: 10,
...
export function getBoughtTogetherSuggestions(productId: string, limit: number = 5) {
  ...
  const scored = otherProducts.map(product => {
    ...
    if (!isCurrentPet && !isProductPet && currentProduct.print_locations && product.print_locations) {
      const productPrintLocations = product.print_locations as string[];
      const commonPrintLocations = (currentProduct.print_locations as string[]).filter(loc =>
        productPrintLocations.includes(loc)
      );
